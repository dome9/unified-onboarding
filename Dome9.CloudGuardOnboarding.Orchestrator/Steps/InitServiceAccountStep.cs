    ...
    public class InitServiceAccountStep : StepBase
    {
        ...
        public override async Task Rollback()
        {
            try
            {
                ...
                await _retryAndBackoffService.RunAsync(() => _apiProvider.UpdateOnboardingStatus(StatusModel.CreateActiveStatusModel(_onboardingId, Enums.Status.PENDING, "Deleting service account")));
