            ...
            try
            {
                ...
                try
                {
                    if (configuration.IntelligenceEnabled)
                    {
                        ...
                        configuration.IntelligenceTemplateS3Path, configuration.IntelligenceStackName, configuration.IntelligenceSnsTopicArn, configurations.IntelligenceRulesSetsIds));
                    }
                    else
                    {
